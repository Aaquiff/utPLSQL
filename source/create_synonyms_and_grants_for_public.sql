...
grant execute on &&ut3_owner..ut_file_reader to public;
grant execute on &&ut3_owner..t_f_array to public;
...
create public synonym ut_file_reader for &&ut3_owner..ut_file_reader;
create public synonym ut_file_reader_array for &&ut3_owner..ut_file_reader_array;
begin
  $if dbms_db_version.version = 12 and dbms_db_version.release >= 2 or dbms_db_version.version > 12 $then
